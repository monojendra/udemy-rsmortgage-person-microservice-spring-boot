...
public class ServiceProperties {
	...
	private String name = "Person Service Data JPA Service";
	
	
	@NotNull // you can also create configurationPropertiesValidator
	private String description = "Person Service Data JPA Service for demoing MIcroservices with database operations";
